#ifndef ZAKERIMANESH_CONVERT_ARRAY_TO_EIGEN_MATRIX_HPP
#define ZAKERIMANESH_CONVERT_ARRAY_TO_EIGEN_MATRIX_HPP
...
#endif  // ZAKERIMANESH_CONVERT_ARRAY_TO_EIGEN_MATRIX_HPP