#ifndef ZAKERIMANESH_CONVERT_ARRAY_TO_EIGEN_VECTOR_HPP
#define ZAKERIMANESH_CONVERT_ARRAY_TO_EIGEN_VECTOR_HPP
...
#endif  // ZAKERIMANESH_CONVERT_ARRAY_TO_EIGEN_VECTOR_HPP